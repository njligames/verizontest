...
void main ()
{
    ...
    lightAttenuation = vec3(1.0, 1.0, 1.0);
    
    vec3 lightPosition = vec3(0.0, 1.0, 0.0);
    
    vec4 modelViewPos = vec4(modelView[3][0], modelView[3][1], modelView[3][2], modelView[3][3]);
    pointToLightVector = lightPosition - vec3(modelViewPos);
